...
p = doc.add_paragraph()
p.alignment = WD_ALIGN_PARAGRAPH.CENTER
run = p.add_run('Version 2.0  |  2026')
run.font.size = Pt(10)
run.font.color.rgb = HELL
...
screenshot('03_manueller_modus.png', 'Manuelle Fehlerauswahl nach Stromkreisen')

# ── Trainingsmodus ────────────────────────────────────────────────────────────
h2('Trainingsmodus')

body('Der Trainingsmodus bietet Lernmaterial zu elektrischen Schutzmaßnahmen. Die Übersichtsseite zeigt die verfügbaren Trainingskategorien, aus denen der Auszubildende auswählen kann.')

h3('Verfügbare Trainingsbereiche')
simple_table(
    ['Trainingsbereich', 'Inhalte'],
    [
        ['Arbeiten spannungsfrei', 'Die 5 Sicherheitsregeln, schrittweise Anleitung, passende Relais aktivierbar'],
        ['Arbeiten unter Spannung', 'Schutzausrüstung, rechtliche Voraussetzungen, Schutzmaßnahmen'],
    ]
)

screenshot('05_trainingsmodus.png', 'Trainingsmodus – Übersicht der Trainingsbereiche')

h3('Training: Arbeiten spannungsfrei')
body('Dieser Bereich erklärt die 5 Sicherheitsregeln für das Arbeiten in spannungsfreiem Zustand. Die Regeln werden schrittweise angezeigt. Über den integrierten Relais-Bereich können passende Übungsfehler direkt aktiviert werden.')
numbered('Im Trainingsmodus "Arbeiten spannungsfrei" auswählen.')
numbered('Die 5 Sicherheitsregeln durchlesen.')
numbered('Gewünschte Relais für die Übung auswählen und aktivieren.')
numbered('Messungen an der Messwand durchführen.')
numbered('"Alle zurücksetzen" drücken nach Abschluss der Übung.')

screenshot('06_training_spfrei.png', 'Training: Arbeiten spannungsfrei – Sicherheitsregeln und Relais-Auswahl')

h3('Training: Arbeiten unter Spannung')
body('Dieser Bereich behandelt Schutzmaßnahmen beim Arbeiten unter Spannung: erforderliche Schutzausrüstung, rechtliche Voraussetzungen und die anzuwendenden Schutzmaßnahmen nach DIN VDE.')

screenshot('07_training_spannung.png', 'Training: Arbeiten unter Spannung – Schutzmaßnahmen')
...
screenshot('08_admin_login.png', 'Admin-Anmeldung per Nummernpad')
...
screenshot('09_admin_panel.png', 'Admin-Panel – Übersicht aller Verwaltungsbereiche')
...
screenshot('11_admin_relais.png', 'Relais-Verwaltung – Konfiguration aller 64 Relais')
...
screenshot('10_admin_config.png', 'Konfiguration – Stromkreise und Kategorien')
...
screenshot('13_admin_database.png', 'Datenbank – Prüfungsprotokoll und Exportfunktion')
...
screenshot('14_admin_netzwerk.png', 'Netzwerk – Verbindungsadressen und WLAN-Verwaltung')
...
screenshot('15_admin_einstellungen.png', 'Einstellungen – Admin-Code und Wallbox')
...
screenshot('09_admin_panel.png', 'Relay Status Monitor – Live-Ansicht aller 64 Relais')
...
screenshot('04_testmodus.png', 'Test-Durchlauf – Automatischer Relais-Selbsttest')
...
body('Der Wartungstest ermöglicht einen strukturierten Funktionstest aller konfigurierten Relais mit Protokoll. Jedes Relais wird einzeln geprüft und das Ergebnis (OK / FEHLER / Übersprungen) wird festgehalten.')

h3('Ablauf')
numbered('Im Admin-Panel oder direkt über /wartungstest aufrufen.')
numbered('"Wartungstest starten" drücken.')
numbered('Das System schaltet jedes Relais nacheinander und wartet auf Bestätigung.')
numbered('Jedes Relais mit "OK", "Fehler" oder "Überspringen" bewerten.')
numbered('Am Ende wird ein Bericht angezeigt: Gesamt, In Ordnung, Fehler, Übersprungen.')
numbered('"Als PDF exportieren" erzeugt einen druckbaren Prüfbericht mit Datum.')

h3('Prüfbericht')
body('Der exportierte PDF-Bericht enthält Datum, alle getesteten Relais mit Namen, Kategorie, Stromkreis sowie das Ergebnis. Fehler werden rot hervorgehoben. Der Bericht eignet sich zur Dokumentation der regelmäßigen Wartung.')

hint_box('Empfehlung: Den Wartungstest nach jeder physischen Änderung an der Messwand sowie regelmäßig (z.B. monatlich) durchführen und den Bericht archivieren.', 'FFF8E1', 'C07000')
screenshot('16_wartungstest.png', 'Wartungstest – Prüfprotokoll mit Ergebnisübersicht')
...
# ── Speichern ─────────────────────────────────────────────────────────────────
output = '/home/vde/VDE-Messwand/docs/Handbuch_VDE-Messwand.docx'
doc.save(output)
