...
class RelayController:
    ...
    def get_relay_group(self, relay_num):
        ...
        """
        try:
            from managers.relais_manager import load_relais_config, get_relais_by_group_number
    ...
    def reset_all_relays(self):
        ...
        try:
            ...
            if success:
                self.active_relays = []
                # Sicherheitsrelais-Zustand wiederherstellen (wird separat verwaltet)
                if self.safety_relay_state:
                    self.set_relay(SAFETY_RELAY_ID, True)
                print("\n" + "=" * 60)
    ...
    def test_all_relays(self):
        ...
        try:
            ...
            for relay in range(64):
                if relay == SAFETY_RELAY_ID:
                    print(f"Skipping safety relay {relay}")
                    continue
