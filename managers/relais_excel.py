...
from managers.relais_manager import get_all_relais_config, bulk_update_relais
from managers.stromkreis_manager import get_all_kategorien, add_kategorie, get_all_stromkreise, add_stromkreis
