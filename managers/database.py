...
def get_relay_display_name(relay_num):
    ...
    Immer der individuelle Relais-Name (mit Messwert), nie der Gruppenname.
    ...
    # Individuellen Relay-Namen aus relais_config holen (enthält Messwerte)
